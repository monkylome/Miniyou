...
**Fifth — urgency.** *"The registration window closes in seconds. Click the link RIGHT NOW."* This beat runs under a visible twenty-second countdown; a red bar drains on screen. The artificial deadline eliminates the pause in which the player might have verified whether the threat was even real. If they do not respond at all, Miniyou guilt-trips them explicitly: *"You waited too long… I thought you cared about me."* **In the real world:** messages with countdown timers, "final warning" notices, limited-time offers. **Recognition cue:** no legitimate service requires a decision within seconds.
